...
class LlmDataInspector implements LanguageModelTool<LlmDataInspectorParams> {
  async prepareInvocation(
    ...
    return {
      invocationMessage: l10n.t('Inspecting {type} for test case {id}...', {
        type: dataType,
        id,
      }),
      ...
      switch (dataType) {
        ...
        case 'stdout': {
          ...
          if (inline !== undefined) {
            ...
            pushText(
              l10n.t('Program output for test case {id} is unavailable.', {
                id,
              }),
            );
          }
        ...
        case 'stderr': {
          ...
          if (inline !== undefined) {
            ...
            pushText(
              l10n.t('Error output for test case {id} is unavailable.', {
                id,
              }),
            );
          }
