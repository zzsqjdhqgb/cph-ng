...
加载测试样例功能允许您一次从外部源导入多个测试样例。它支持从 zip 压缩包或目录文件夹加载，自动匹配输入（.in）文件与答案（.out、.ans）文件。
...
- [添加测试样例](add-test-case.md) - 手动添加单个用例
- [编辑测试样例](edit-test-case.md) - 修改导入的用例
